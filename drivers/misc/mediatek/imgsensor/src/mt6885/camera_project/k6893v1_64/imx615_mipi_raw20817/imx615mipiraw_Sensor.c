...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX615_SENSOR_ID_20817 - SENSOR_ID_OFFSET_20817,
...
static void read_EepromQSC(void)
{
    ...
    gImgEepromInfo_20817.camNormdata[1][0] = Eeprom_1ByteDataRead(0x00, 0xA8);
    gImgEepromInfo_20817.camNormdata[1][1] = Eeprom_1ByteDataRead(0x01, 0xA8);
    imgsensor_info.module_id = Eeprom_1ByteDataRead(0x00, 0xA8);
    Oplusimgsensor_Registdeviceinfo(gImgEepromInfo_20817.pCamModuleInfo[1].name,
                                    gImgEepromInfo_20817.pCamModuleInfo[1].version,
                                    imgsensor_info.module_id);
    for(i = 2; i < 8; i++) {
        gImgEepromInfo_20817.camNormdata[1][i] = Eeprom_1ByteDataRead(0x04+i, 0xA8);
    }
    for (i = 0; i < OPLUS_CAMERASN_LENS; i ++) {
        gImgEepromInfo_20817.camNormdata[1][8+i] = Eeprom_1ByteDataRead(0xB0+i, 0xA8);
    }
    gImgEepromInfo_20817.i4CurSensorIdx = 1;
    gImgEepromInfo_20817.i4CurSensorId = IMX615_SENSOR_ID_20817;
}
